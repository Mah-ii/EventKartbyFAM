...
<html lang="en">
    ...
    <body>
        ...
        <div class="row justify-content-center mt-5">
            <div class="col-lg-4 col-md-6 col-sm-12">
                <form action="R_insert.php" method="post">
                    <div class="mb-3">
                           <h3>SIGN UP</h3> 
                    </div>
                    <div class="form-row">
    ...
    <input type="text" name="pass" class="form-control" id="inputAddress" placeholder="PASSWORD">
  </div>
    <div class="form-group col-md-6">
      <label for="inputPassword4">Name</label>
      <input type="text" name="username" class="form-control" id="inputPassword4" placeholder="NAME">
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
  <input type="submit" name="submit"  class="form-control" id="inputddress2" value="Submit" style="font-weight:bold;">
  <a href="display.php" style="color:black">Update/Delete</a>
      </form>
