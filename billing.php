...
<html lang="en">
    ...
    <body>
<!--- nav starts--->
<!---< class="navbar navbar-expand-lg navbar-light bg-light" style="color: red;"> --->
...
<nav class="navbar navbar-expand-lg navbar-light bg-light custom-nav">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="receiption.php" style="color: white;">Reception</a>
            </li>
        </ul>
    </div>
</nav>
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-6">
      <label for="inputPassword4">Member</label>
